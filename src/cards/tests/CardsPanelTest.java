package cards.tests; //Change me


/**
 * Project imports
 */
import cards.controller.Controller; //Change me
import cards.view.CardsPanel; //Change me
import javax.swing.*;
...
class PanelTest
{
	...
	private CardsPanel testedPanel; //Change me

	@BeforeEach
	void setUp() throws Exception
	{
		this.testedController = new Controller(); //Change me
		this.testedPanel = new CardsPanel(testedController); //Change me
	} 
